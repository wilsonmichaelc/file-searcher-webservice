 ...
 * @version Feb 2, 2012
 */
public class DropTmpFiles {

	private static Logger log = Logger.getLogger(DropTmpFiles.class);
	private static final String QUERY = "DROP TABLE IF EXISTS files_tmp;";
